...
const Hero = () => {
	return (
		<div
			className=' bg-white overflow-hidden bg-cover lg:inset-y-0 lg:right-0 lg:w-full'
			style={{
				backgroundImage: 'linear-gradient(rgba(0 0 0 / 60%), rgba(0 0 0 /60%)), url(/slide1-lingerie.jpeg)',
				maxHeight: '65vh',
			}}
		>
				...
				<div className='relative z-10 pb-8 bg-transparent sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32'>
					...
					<div>
						<div className='relative pt-6 px-4 sm:px-6 lg:px-8'>
							<nav className='relative flex items-center justify-between sm:h-10 lg:justify-start' aria-label='Global'></nav>
						</div>
