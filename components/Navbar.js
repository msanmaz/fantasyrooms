            ...
            <div className="mt-2">
              ...
              <div id="tabs-1-panel-1" className="pt-10 pb-8 px-4 space-y-10" aria-labelledby="tabs-1-tab-1" role="tabpanel" tabIndex="0">
                ...
                <div>
                  ...
                  {cats.map((categories) => (
                                      <li className="flex">
                                        <Link href={`/categories/${categories.slug}`}className="hover:text-gray-800">
                                          <p className="hover:text-gray-800 text-gray-500 cursor-pointer">
                                            {categories.name}
                                          </p>
