    ...
    return (
        ...
        <div className="p-2 lg:p-5">
          ...
          <div className="flex flex-col justify-between">
            <button className="bg-gradient-to-r from-red-600 to-pink-500 rounded-full py-2 px-4 my-2 text-xs text-white hover:bg-pink-600 hover:from-pink-600 hover:to-pink-600 flex flex-row justify-center" onClick={() => { addToCart(); handleClick() }}>
            ...
            <button className="bg-purple-600 rounded-full py-2 px-4 my-2 text-xs text-white hover:bg-purple-700 flex flex-row justify-center" href="#">
